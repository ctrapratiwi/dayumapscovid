...
<div class="container-fluid">
	<div class="row header">
        ...
        <div class="row col-lg-1">
            <a class="admin" href="/pasien">DATA</a>
        </div>

   	</div><!-- End Header -->

    <div class="row info2">
    	Data Penyebaran Covid-19 (Bali)
    </div>
    ...
    <div class="row info">
        ...
        <div class="row info">
        	...
        	<div class="card" style="width: 80rem;">
              ...
              <div class="card-body">
                    <h5 class="card-title">Peta Penyebaran Kasus Covid - 19 di Bali</h5>
              </div>
              ...
              <div class="row mt-2">
                <div class="col-12">
                  <button class="btn btn-success form-control" id="btnGenerateColor">Generate Color</button>
                </div>
